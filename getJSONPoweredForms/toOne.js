...
const toPrint = Object.entries(all).map((i) => {
	return { definition: i[1], name: i[0].split('|')[0], context: i[0].split('|')[1], _partitionKey: i[0] };
});

console.log(JSON.stringify(toPrint, undefined, 2));
